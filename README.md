...
A personal collection of configuration files, skills, and commands for AI coding assistants. While this repository is primarily maintained for personal use, you're welcome to use anything here for your own projects.

## Installation

Skills can be installed using [Vercel's skills.sh](https://skills.sh):

```bash
npx skills add https://github.com/StefanMermans/agent-config --skill <skill-name>
```
...
- **Skills** - Reusable instruction sets for AI coding assistants
- **Commands** - Custom slash commands for common workflows
- **Configs** - Configuration files for various AI tools

## License

This project is released under [The Unlicense](LICENSE) - feel free to use anything here for any purpose.
